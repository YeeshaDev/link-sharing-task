      ...
      <div className="md:flex md:items-center md:justify-end md:gap-5">
        <div className="flex my-4">
          <label
            ...
            className="relative w-[193px] h-[193px] flex flex-col items-center justify-center gap-2 cursor-pointer bg-neutral-light-purple hover:shadow-lg border border-transparent rounded-corner hover:border-primary-index transition-all duration-300"
          >
            {!imageUrl ? (
              <>
                <UploadImageIcon />
              ...
              <>
                <NextImage
                  ...
                  priority
                  sizes="193px"
                  className="object-cover rounded-corner"
                />
